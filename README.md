# Industrial-Programming-Technologies-Practice-11 (ЭФМО-02-24 Кучер Артем Сергеевич)
## Интеграция REST API с базой данных (PostgreSQL) на Go (Интернет-магазина электронники)

### 1)Получение всех товаров
![image](https://github.com/user-attachments/assets/1a92bddc-d456-49c8-836e-d53ff002fc54)

### 2)Получение товара по ID
![image](https://github.com/user-attachments/assets/11e1bcc8-6621-4c4e-a13e-f9cd3a9a45d2)

### 3)Создание нового товара
![image](https://github.com/user-attachments/assets/01a25107-27ed-4a1d-9b90-e4f67d962b14)

### 4)Обновление существующего товара
![image](https://github.com/user-attachments/assets/00e14492-3f68-4177-8da6-91f92a13d973)

### 5)Удаление товара
![image](https://github.com/user-attachments/assets/128d75e3-9309-4e1a-a90b-fcef2ea0e367)
